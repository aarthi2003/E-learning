...
?>
   <section class="edit-comment">
      ...
      <form action="" method="post">
         ...
         <div class="flex">
            <a href="play_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">cancel edit</a>
...
?>
   ...
   <section class="comments">
      ...
      <form action="" method="post" class="add-comment">
         ...
         <textarea name="comment_box" required placeholder="Add a comment" maxlength="1000" cols="30"
            rows="10"></textarea>
