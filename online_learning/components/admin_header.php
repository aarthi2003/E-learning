...
<header class="header">
    ...
    <section class="flex">
        ...
        <div class="profile">
            ...
            <a href="../components/admin_logout.php" onclick="return confirm('Logout from this website?');" class="option-btn">logout</a>
...
<div class="side-bar">
    ...
    <nav class="navbar">
        ...
        <a href="contents.php"> <i class="fas fa-graduation-cap"></i> <span>Content</span></a>
