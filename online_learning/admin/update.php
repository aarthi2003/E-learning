        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="col">
                    ...
                    <p>Name</p>
                    <input type="text" name="name" maxlength="50" placeholder="<?= $fetch_profile['name']; ?>"
                        class="box">
                    <p>Profession</p>
                    ...
                    <p>Email</p>
                    <input type="email" name="email" maxlength="50" placeholder="<?= $fetch_profile['email']; ?>"
                        class="box">
                ...
                <div class="col">
                    ...
                    <input type="password" name="old_pass" placeholder="Enter current password" maxlength="20"
                        class="box">
                    <p>New password</p>
                    <input type="password" name="new_pass" placeholder="Enter new password" maxlength="20" class="box">
                    <p>Confirm password</p>
                    <input type="password" name="cpass" placeholder="Confirm new password" maxlength="20" class="box">
            ...
            <input type="submit" name="submit" value="Update" class="main-btn">
