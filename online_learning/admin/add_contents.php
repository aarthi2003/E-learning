...
<body>
    ...
    <section class="video-form">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" class="box" required name="title" maxlength="100" placeholder="Enter title of video">
            ...
            <input type="submit" value="Add video" name="submit" class="main-btn">
