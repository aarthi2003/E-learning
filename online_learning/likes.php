   ...
   ?>
         <div class="box">
            ...
            <form action="" method="post" class="flex-btn">
               ...
               <a href="play_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">watch video</a>
         ...
         {
            echo '<p class="emtpy">Content not found</p>';         
         }
      }
   }
   else
   {
      echo '<p class="empty">No videos added</p>';
   }
   ?>
